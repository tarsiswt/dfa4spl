...
public class CopyOfWholeLineSimpleReachingDefinitionsAnalysis extends BodyTransformer {

	private static CopyOfWholeLineSimpleReachingDefinitionsAnalysis instance = new CopyOfWholeLineSimpleReachingDefinitionsAnalysis();

	private CopyOfWholeLineSimpleReachingDefinitionsAnalysis() {
	}

	public static CopyOfWholeLineSimpleReachingDefinitionsAnalysis v() {
		return instance;
	}
