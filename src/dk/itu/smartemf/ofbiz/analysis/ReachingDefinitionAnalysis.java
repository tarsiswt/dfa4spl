...
public class ReachingDefinitionAnalysis extends MonotonicDataFlowFramework<Pair<String, ASTNode>> {
	...
	@Override
	String toString(Pair<String, ASTNode> e) {
		return e.first + " <" + Util.getFirstLine(e.second) + ">";
	}

	@SuppressWarnings("unchecked")
	@Override
	protected Set<Pair<String, ASTNode>> gen(Set<Pair<String, ASTNode>> set, Statement stmt) {
	...
	@SuppressWarnings("unchecked")
	@Override
	protected Set<Pair<String, ASTNode>> kill(Set<Pair<String, ASTNode>> set, Statement stmt) {
		Set<Pair<String, ASTNode>> result = new HashSet<Pair<String, ASTNode>>();
